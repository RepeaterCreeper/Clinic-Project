...
<body>
    ...
    <div class="rounded-md m-4 flex gap-4">
        <div class="flex-1 shadow-md flex justify-between items-center p-2 rounded-md">
            <h1 class="font-bold text-2xl">Add New Clinic</h1>
            <a class="bg-indigo-600 px-8 py-2 font-medium text-white rounded-md hover:bg-indigo-800" href="index.php">Go Back</a>
        </div>
    </div>
</body>
</html>